...
public class CustomerService {
	...
	private static final Pattern CUSTOMER_NUMBER_PATTERN = Pattern.compile("\\d{8}");
	...
	public Customer getCustomerByNumber(String customerNumber) {
		...
		return customerRepository
			...
			.orElseThrow(() -> new CustomerNotFoundException("Customer not found for number: " + customerNumber));
	}
